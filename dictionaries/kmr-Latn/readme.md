...
Northern Kurdish (Latin script) spelling dictionary.

## Contents

## What is this?

This is a Northern Kurdish (Latin script) dictionary,
...
```sh
npm install dictionary-kmr-latn
```

## Use

```js
import kmrLatn from 'dictionary-kmr-latn'

console.log(kmrLatn)
// To do: use `kmrLatn` somehow
```
...
[GPL-3.0](https://github.com/vandrite/vadrite-dictionaries/blob/main/dictionaries/kmr-Latn/license).
