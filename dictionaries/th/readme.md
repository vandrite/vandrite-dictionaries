...
```sh
npm install dictionary-th
```

## Use

```js
import th from 'dictionary-th'

console.log(th)
// To do: use `th` somehow
```
...
[LGPL-2.1](https://github.com/vandrite/vadrite-dictionaries/blob/main/dictionaries/th/license).
