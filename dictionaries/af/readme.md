...
Afrikaans spelling dictionary.

## Contents

## What is this?

This is a Afrikaans dictionary,
...
```sh
npm install dictionary-af
```

## Use

```js
import af from 'dictionary-af'

console.log(af)
// To do: use `af` somehow
```
...
[LGPL-3.0](https://github.com/vandrite/vadrite-dictionaries/blob/main/dictionaries/af/license).
