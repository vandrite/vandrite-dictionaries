...
```sh
npm install dictionary-bn
```

## Use

```js
import bn from 'dictionary-bn'

console.log(bn)
// To do: use `bn` somehow
```
...
[GPL-2.0](https://github.com/vandrite/vadrite-dictionaries/blob/main/dictionaries/bn/license).
