...
Paraguayan Guaraní spelling dictionary.

## Contents

## What is this?

This is a Paraguayan Guaraní dictionary,
...
```sh
npm install dictionary-gug
```

## Use

```js
import gug from 'dictionary-gug'

console.log(gug)
// To do: use `gug` somehow
```
