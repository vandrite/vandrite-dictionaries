...
```sh
npm install dictionary-lo
```

## Use

```js
import lo from 'dictionary-lo'

console.log(lo)
// To do: use `lo` somehow
```
...
[GPL-3.0](https://github.com/vandrite/vadrite-dictionaries/blob/main/dictionaries/lo/license).
