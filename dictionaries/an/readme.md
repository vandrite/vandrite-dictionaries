...
This is a Aragonese dictionary,
...
```sh
npm install dictionary-an
```

## Use

```js
import an from 'dictionary-an'

console.log(an)
// To do: use `an` somehow
```
...
[GPL-3.0](https://github.com/vandrite/vadrite-dictionaries/blob/main/dictionaries/an/license).
