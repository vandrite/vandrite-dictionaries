...
Central Kurdish spelling dictionary.

## Contents

## What is this?

This is a Central Kurdish dictionary,
...
```sh
npm install dictionary-ckb
```

## Use

```js
import ckb from 'dictionary-ckb'

console.log(ckb)
// To do: use `ckb` somehow
```
...
[GPL-3.0](https://github.com/vandrite/vadrite-dictionaries/blob/main/dictionaries/ckb/license).
