...
Tamil spelling dictionary.

## Contents

## What is this?

This is a Tamil dictionary,
...
```sh
npm install dictionary-ta
```

## Use

```js
import ta from 'dictionary-ta'

console.log(ta)
// To do: use `ta` somehow
```
...
[GPL-3.0](https://github.com/vandrite/vadrite-dictionaries/blob/main/dictionaries/ta/license).
